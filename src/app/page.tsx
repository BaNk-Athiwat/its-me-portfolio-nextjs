...
const Portfolio = () => {
	...
	const logos = [
		{
			name: "Next.js",
			icon: <StackIcon name="nextjs2" className="w-16 h-16 rounded" />,
		},
		{
			name: "Angular",
			icon: <StackIcon name="angular" className="w-16 h-16 rounded" />,
		},
		{
			name: "Tailwind CSS",
			icon: (
				<StackIcon name="tailwindcss" className="w-16 h-16 rounded" />
			),
		},
		{
			name: "Bootstrap",
			icon: <StackIcon name="bootstrap4" className="w-16 h-16 rounded" />,
		},
		{
			name: "Spring Boot",
			icon: <StackIcon name="spring" className="w-16 h-16 rounded" />,
		},
		{
			name: "Node.js",
			icon: <StackIcon name="nodejs" className="w-16 h-16 rounded" />,
		},
		{
			name: "PostgreSQL",
			icon: <StackIcon name="postgresql" className="w-16 h-16 rounded" />,
		},
		{
			name: "MariaDB",
			icon: <StackIcon name="mariadb" className="w-16 h-16 rounded" />,
		},
		{
			name: "MongoDB",
			icon: <StackIcon name="mongodb" className="w-16 h-16 rounded" />,
		},
		{
			name: "Docker",
			icon: <StackIcon name="docker" className="w-16 h-16 rounded" />,
		},
		{
			name: "Kubernetes",
			icon: <StackIcon name="kubernetes" className="w-16 h-16 rounded" />,
		},
		{
			name: "MinIO",
			icon: (
		...
		{
			name: "Jira",
			icon: <StackIcon name="jira" className="w-16 h-16 rounded" />,
		},
		{
			name: "Git",
			icon: <StackIcon name="git" className="w-16 h-16 rounded" />,
		},
		{
			name: "Bitbucket",
			icon: <StackIcon name="bitbucket" className="w-16 h-16 rounded" />,
		},
	];
						...
						<div className="absolute top-1/2 transform -translate-y-1/2 animate-seamless-scroll">
							<div className="flex items-center space-x-8">
								{logos.concat(logos).map((logo, index) => (
									...
									>
										<div className="mb-4">{logo.icon}</div>
